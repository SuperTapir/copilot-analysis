var import_os = require("os"),
  import_vscode_uri = Dr(qp());,var _GitRemoteUrl = class _GitRemoteUrl {
  constructor(url) {
    this.url = url;
  ...
  getUrlForApi() {
    ...
    if (this.isUrl() && !this.isInvalid()) return tT.URI.from({
      scheme: this.scheme,
  ...
  tryParseSSHString() {
    ...
    if (match && ((0, qJ.platform)() !== "win32" || ((_c = (_b = (_a = match.groups) == null ? void 0 : _a.host) == null ? void 0 : _b.length) != null ? _c : 0) > 1)) {
