var quietLight = {
  ...
  tokenColors: [{
    ...
    scope: ["comment.documentation", "comment.block.documentation", "comment.block.documentation punctuation.definition.comment "],
    settings: {
      foreground: "#448C27"
    }
  }, {
    ...
    scope: ["entity.name.type", "entity.name.namespace", "entity.name.scope-resolution", "entity.other.inherited-class", "support.class"],
    settings: {
      foreground: "#7A3E9D",
      fontStyle: "bold"
    }
    ...
    scope: ["punctuation.definition.tag.js", "punctuation.definition.tag.begin.js", "punctuation.definition.tag.end.js"],
    settings: {
      foreground: "#91B3E0"
    }
  }, {
