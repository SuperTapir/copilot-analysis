...
},__name(linearInterpolation, "linearInterpolation");,var _Regressor = class _Regressor {
...
};,__name(_Regressor, "Regressor");,var Regressor = _Regressor,
