var path = require("path"),
  ...
  _LanguageDetection = class _LanguageDetection {};,__name(_LanguageDetection, "LanguageDetection");,var LanguageDetection = _LanguageDetection;,function getLanguageDetection(ctx) {
